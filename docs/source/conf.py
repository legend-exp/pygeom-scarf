...
version = importlib.metadata.version("pygeom-scarf")
...
html_theme = "furo"
html_theme_options = {
    "source_repository": "https://github.com/legend-exp/pygeom-scarf",
    "source_branch": "main",
...
intersphinx_mapping = {
    ...
    "legendoptics": ("https://legend-pygeom-optics.readthedocs.io/en/stable/", None),
